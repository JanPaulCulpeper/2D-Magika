...
public class Chest3 extends StaticEntity{
	...
	public void render(Graphics g) {
		...
		if (CI) {
			...
			g.drawString(String.valueOf(getItem1Amount())+"/2", 710,25+30);
	    	...
	    	g.drawString("The Goblins are",(int)(x-handler.getGameCamera().getxOffset())+140,(int)(y-handler.getGameCamera().getyOffset())-70);
	    	g.drawString("the end of your problems!",(int)(x-handler.getGameCamera().getxOffset())+140,(int)(y-handler.getGameCamera().getyOffset())-45);
