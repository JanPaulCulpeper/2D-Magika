 ...
 */
public class Goblin extends CreatureBase  {
    ...
    public Goblin(Handler handler, float x, float y) {
        ...
        animDown = new Animation(animWalkingSpeed, Images.Goblin_front);
        animLeft = new Animation(animWalkingSpeed,Images.Goblin_left);
        animRight = new Animation(animWalkingSpeed,Images.Goblin_right);
        animUp = new Animation(animWalkingSpeed,Images.Goblin_back);
    ...
    public void render(Graphics g) {
        g.drawImage(getCurrentAnimationFrame(animDown,animUp,animLeft,animRight,Images.Goblin_front,Images.Goblin_back,Images.Goblin_left,Images.Goblin_right), (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
        if(isBeinghurt() && healthcounter<=120){
            g.setColor(Color.white);
            g.drawString("Goblin: " + getHealth(),(int) (x-handler.getGameCamera().getxOffset()),(int) (y-handler.getGameCamera().getyOffset()-20));
        }
    }
