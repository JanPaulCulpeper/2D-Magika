 ...
 */
public class GoldenBoy extends CreatureBase  {
    ...
    public GoldenBoy(Handler handler, float x, float y) {
        ...
        animDown = new Animation(animWalkingSpeed, Images.GoldenBoy_front);
        animLeft = new Animation(animWalkingSpeed,Images.GoldenBoy_left);
        animRight = new Animation(animWalkingSpeed,Images.GoldenBoy_right);
        animUp = new Animation(animWalkingSpeed,Images.GoldenBoy_back);
    ...
    public void render(Graphics g) {
        g.drawImage(getCurrentAnimationFrame(animDown,animUp,animLeft,animRight,Images.GoldenBoy_front,Images.GoldenBoy_back,Images.GoldenBoy_left,Images.GoldenBoy_right), (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
        if(isBeinghurt() && healthcounter<=120){
            g.setColor(Color.white);
            g.drawString("GoldenBoy: " + getHealth(),(int) (x-handler.getGameCamera().getxOffset()),(int) (y-handler.getGameCamera().getyOffset()-20));
        }
    }
